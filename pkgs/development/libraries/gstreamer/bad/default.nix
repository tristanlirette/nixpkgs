...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    (fetchpatch {
      url = "https://gitlab.freedesktop.org/gstreamer/gstreamer/-/commit/571ebf4a15c4486d8851ac2d0c27c513a3c5b435.patch";
      stripLen = 3;
      extraPrefix = "";
      hash = "sha256-gw2q+gzQtF+uLXrdla2tzpJtoXnkuS+Xpin8FP2AfuA=";
    })
  ];
